...
async function markdown() {
	const organization = 'electron-userland'; // change this if you want to use a different organization
	...
	fs.writeFile(path.resolve(`./retros/userland-${dates.start}.md`), retro);
}
